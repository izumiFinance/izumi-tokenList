...
export const tokens: TokenInfo[] = [
    ...
    },
    {
        ...
        chains: [ChainId.Izumi, ChainId.OpsideRolluxTest,ChainId.BSCTestnet, ChainId.AuroraTestnet, ChainId.RolluxBedrockTest, ChainId.SkaleTest, ChainId.GasZeroGoerliL2],
        contracts: {
            [ChainId.Izumi]: {
